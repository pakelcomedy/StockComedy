...
class StockFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        stockAdapter = StockAdapter(stockList) { stockName ->
            onStockItemClicked(stockName)
        }
    ...
    private fun onStockItemClicked(stockName: String) {
        val action = StockFragmentDirections.actionStockFragmentToChartFragment(stockName)
